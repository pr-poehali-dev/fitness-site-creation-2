...
export const REVIEWS = [
  ...
  { name: "Ольга Б.", role: "Дизайнер", rating: 5, text: "Атмосфера SISTEM вдохновляет. Красивый интерьер, приятная музыка, мотивированные люди вокруг. Каждая тренировка — это ритуал заботы о себе.", avatar: "ОБ" },
];
